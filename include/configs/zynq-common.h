...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"qspiboot=echo Copying Linux from QSPI flash to RAM... && " \
		...
		"setenv bootargs console=ttyPS0,115200 root=/dev/mtd4 rw earlyprintk && " \
		"bootm ${kernel_load_address} ${ramdisk_load_address} ${devicetree_load_address}\0" \
	"uenvboot=" \
...
/* toss the post word somewhere */
#define CONFIG_SYS_POST_WORD_ADDR CONFIG_SYS_SPL_MALLOC_START
